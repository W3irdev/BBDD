...
CONSTRAINT CHK_FECHAYHORA CHECK (to_char(FECHAYHORA, 'HH24:MI')>'09:00' AND TO_CHAR(FECHAYHORA, 'HH24:MI')<'14:30'),/*(TO_CHAR(FECHAYHORA)>TO_CHAR('09:00','HH:MM')AND TO_CHAR(FECHAYHORA)<TO_CHAR('14:30','HH:MM')),*/
...
VALUES ('1', TO_DATE('17-04-2023 10:00', 'DD-MM-YYYY HH24:MI'), 1000, 15000);
...
ALTER TABLE PARTICIPACIONES ADD CONSTRAINT CHK_NOMBRE CHECK (REGEXP_LIKE(JOCKEY,'^[A-Z]')); /* (JOCKEY=INITCAP(JOCKEY));

/*ALTER TABLE CARRERAS ADD CONSTRAINT CHK2_FECHA CHECK (FECHAYHORA , 'DD/MM') BEETWEEN '10/3' AND '10/11';*/

ALTER TABLE CABALLOS ADD CONSTRAINT CHK5_NACIONALIDAD CHECK (NACIONALIDAD IN ('ESPAÑOLA','BRITANICA','ARABE'));

DELETE FROM CARRERAS WHERE CODCARRERA NOT IN (SELECT CODCARRERA  FROM PARTICIPACIONES);

ALTER TABLE CLIENTES ADD CODIGO VARCHAR2(10) UNIQUE;
